...
public class UsingArrays 
{
   ...
   private final double doubleArray1[] = { 7.3, 8.6, 4.3, 5.2, 1.8 };
   private final double[] doubleArray2;
   ...
   public UsingArrays()
   {
      ...
      System.arraycopy( intArray, 0, intArrayCopy,
         0, intArray.length );
      System.arraycopy(doubleArray2, 0, doubleArray,0, doubleArray2.length );
     // System.arraycopy(doubleArray2, 5, doubleArray1,0,doubleArray2.length );
      
      Arrays.sort( doubleArray2 ); // sort doubleArray ascending
